...
1. Build the project and push an image to the container registry with the following command:
	...
	**Note:** You will use the api key in the file we created at the end of the [Configure IBM Cloud](#configure-ibm-cloud). Be sure to use the value **iamapikey** for the username.
